@extends('v2.structor.main',['title'=> 'Đăng ký phòng khám'])
@section('content')
<style>
    pre {
...
<main id="main-content" class="main-content" style="min-height: 63px;">
    <div class="bac-si-page">
        <div class="bac-si-page__benefit">
            <div class="container">
                <h2>TDoctor đảm bảo những quyền lợi cho Phòng khám</h2>
        ...
        <div class="bac-si-page__doctor">
            <div class="container">
                <h2>Phòng khám tham gia cùng TDoctor</h2>
                <p>Hiện đã có <strong>{{$numberDoctor}}</strong> phòng khám</p>
                                ...
                                <div class="owl-stage"
                                    ...
                                    <div class="owl-item active" style="width: 200.666px;"><a class="doctor__item">
                                            <img class="doctor__avatar lazy" alt="Bác sĩ"
                                                 src="{{url('public/images/health_facilities/'.$doctor->profile_image)}}" style="">
        ...
        <div class="bac-si-page__registry">
            <div class="container">
                <h2>Tạo hồ sơ Phòng khám miễn phí với 3 bước</h2>
                <p>Hiện đã có <strong>{{$numberDoctor}}</strong> Phòng khám</p>
                ...
                <div class="row">
                            ...
                            <ul class="registry__processes-list">
                                <li class="registry__processes-item">
                                    ...
                                    <div class="registry__processes-info">
                                        ...
                                        <p class="registry__processes-content">
                                            Tạo hồ sơ Phòng khám mới bằng mẫu đăng ký
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li class="registry__processes-item">
                                    ...
                                    <div class="registry__processes-info">
                                        ...
                                        <p class="registry__processes-content">
                                            Bổ sung đầy đủ thông tin cần thiết cho hồ sơ Phòng khám
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li class="registry__processes-item">
                                    ...
                                    <div class="registry__processes-info">
                                        ...
                                        <p class="registry__processes-content">
                                            TDoctor xác thực hồ sơ và Phòng khám bắt đầu giúp đỡ mọi người
                                        </p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="offset-xl-2 col-xl-4" id="doctor_register_area">
                        <div class="registry__content-right">
                            <h3>Tạo hồ sơ phòng khám</h3>
                            ...
                            <form action="/v2/dang-ky" method="post" class="form-horizontal ajax-form-registry form-registry formClazz" id="form_registry" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    <label class="label-control">Tên cơ sở y tế</label>
                                    <input class="form-control nameClazz" required name="clinicname">
                                </div>
                                <div class="form-group">
                                    <label class="label-control">Hình ảnh</label>
                                    <input name="hinhanh" placeholder="" class="form-control"  type="file">
                                </div>

                                <div class="form-group">
                                    <label class="label-control">Mô tả</label>
                                    <textarea name="description" id="content" class="form-control ckeditor"  type="text"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="label-control">Giờ làm việc</label>
                                    <input name="clinic_timeopen" placeholder="" class="form-control" type="text" data-role="tagsinput">
                                </div>                                
                                @endif

                                 <div class="form-group">
                                        <label class="label-control">Tên cơ sở y tế</label>
                                        <input class="form-control nameClazz" required="required" placeholder="Nhập tên cơ sở y tế..." name="name">
                                    </div>
                                    ...
                                    <div class="hidden">
                                        ...
                                        <input type="hidden" value="/dang-ky-phong-kham" name="goto" />
                                    </div>
