...
<div class="main-A">
	<div class="abu-cnt">
	    ...
	    <div class="top-new">
                    ...
                    <p style="font-size: 16px;">Chúng tôi là những bác sĩ nhiều kinh nghiệm, chúng tôi phục vụ người bệnh mọi lúc mọi nơi. <a style="font-size: 16px; color: #2b96cc;" href="https://tdoctor.vn/">tdoctor.vn</a>  là công ty công nghệ với mong muốn sẽ xây dựng được một hệ thống chăm sóc sức khỏe toàn diện thông qua ứng dụng trên điện thoại và web. Ứng dụng tdoctor trên smartphone / tablet phiên bản Android và IOS cung cấp dịch vụ chăm sóc sức khỏe chủ động đầu tiên tại Việt Nam. Dựa trên nền tảng công nghệ thông tin, ứng dụng tdoctor giúp kết nối người dùng và Bác Sĩ dễ dàng ở mọi lúc, mọi nơi. Người dùng có thể sử dụng ứng dụng để được tư vấn sức khỏe, tra cứu thuốc & phòng khám, cùng các dịch vụ sức khỏe khác.</p>
                    ...
                    <div class="media" id="leader" >
                        ...
                        <h2 >1.  ĐỖ HỮU TUYỂN </h2>
                        <img  src="../public/images/aboutUs/dohuutuyen.jpg" alt="Sunil Shroff" >
                        <p >
                            <b class="cl-b">Chức danh:</b> <b >CHỦ TỊCH HỘI ĐỒNG QUẢN TRỊ  </b> 
                            <br><br>
                            <b class="cl-b">Chuyên môn:</b> <b >Kỹ sư Công Nghệ Sinh Học </b>
                            <br><br>
                            <b class="cl-b">Trường đào tạo:</b> <b > ĐẠI HỌC BÁCH KHOA HÀ NỘI </b>
                         </p>
                    </div>
                    ...
                    <div class="media" id="leader">
                        ...
                        <h2 >4. NGUYỄN THÀNH ĐẠT</h2>
                        <img  src="../public/images/aboutUs/nguyenthanhdat01.jpg" alt="Sunil Shroff">
                        <p >
                    ...
                    <div class="media" id="leader">
                        ...
                        <h2 >5. LƯƠNG MỘNG ÁI NHI</h2>
                        <img  src="../public/images/aboutUs/luongmongainhi.jpg" alt="Sunil Shroff">
                        <p >
                            <b class="cl-b">Chức danh:</b> <b >TRƯỞNG PHÒNG CHIẾN LƯỢC </b>
                            <br><br>
                            <b class="cl-b">Chuyên môn:</b> <b >
