	...
	<div class="position" id="list-cms">
        <div class="content">
            ...
            <div class="top-new">
                    ...
                    <p>Chúng tôi là những bác sĩ nhiều kinh nghiệm, chúng tôi phục vụ người bệnh mọi lúc mọi nơi. <a href="https://tdoctor.vn/">tdoctor.vn</a>  là công ty công nghệ với mong muốn sẽ xây dựng được một hệ thống chăm sóc sức khỏe toàn diện thông qua ứng dụng trên điện thoại và web. Ứng dụng BacsiViet trên smartphone / tablet phiên bản Android và IOS cung cấp dịch vụ chăm sóc sức khỏe chủ động đầu tiên tại Việt Nam. Dựa trên nền tảng công nghệ thông tin, ứng dụng BacsiViet giúp kết nối người dùng và Bác Sĩ dễ dàng ở mọi lúc, mọi nơi. Người dùng có thể sử dụng ứng dụng để được tư vấn sức khỏe, tra cứu thuốc & phòng khám, cùng các dịch vụ sức khỏe khác.</p>
                    ...
                    <h4>2.  Văn hóa tại <a href="https://tdoctor.vn/">www.tdoctor.vn</a></h4>
