@extends('v2/structor/main',['title'=> 'Danh sách nhà thuốc', 'meta_keywords' => 'danh sách nhà thuốc, nhà thuốc uy tín, nhà thuốc giả rẻ, nơi bán thuốc, nhà thuốc bán aspirin( vv tùy loại thuốc)'])
@section('content')
<div class="main-A">
	<div id="top">
            <div class="link">
                <div class="nav">
                    <ul>
                        ...
                        <li>&nbsp;>&nbsp;</li>
                        <li><a href="/danh-sach-nha-thuoc">Danh sách nhà thuốc</a></li>
                    </ul> 
        ...
        @if(request()->input('q')!==null)
            ...
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <a href="/danh-sach-nha-thuoc/?q={{request()->input('q')}}" class="active">
	 ...
	 <div class="cnt-nthuoc">
		<div id="filter-summarys">
			<form class="form-inline" action="/danh-sach-nha-thuoc/" method="get">
				...
				<button type="submit" class="submit-nt">Lọc kết quả</button>
			</form>
