        ...
        <div class="inner">
            <div class="has-bg clr">
                <div class="span span4 m alone text-center">
                    <h1 class="counter ctr1" data-count="{{$countClinic}}">{{$countClinic}}</h1>
                    <em key="cli" class="langtr">Clinic</em></div>
                <div class="span span4 m alone text-center">
                    <h1 class="counter ctr2" data-count="{{$countDoctor}}">{{$countDoctor}}</h1>
                    <em key="doc" class="langtr">Doctor</em></div>
                <div class="span span4 m alone text-center">
                    <h1 class="counter ctr3" data-count="{{$countDrugstore}}">{{$countDrugstore}}</h1>
                    <em key="drug" class="langtr">Drugstore</em></div>
                <div class="span span4 m alone text-center">
                    <h1 class="counter ctr4" data-count="{{$countUser}}">{{$countUser}}</h1>
