@extends('v2/structor/main',['title'=> 'Khuyến mãi'])
@section('content')
<div class="main-A">
	<div id="top">
            <div class="link">
                ...
                <h1 style="font-size: 18px;">Danh sách khuyến mãi</h1>
            </div> 
	 </div><!-- #top -->
	 <div class="km-cnt">
	 	<div class="menu-km-cnt">
	 		<ul>
				<li>
					<a href="/khuyenmai/" class="@if(empty(app('request')->input('categories'))) active @endif">nổi bật nhất</a>
				</li>
		...
		<div class="promotion-list">
				...
				@if(isset($deals))
				  @foreach($deals as $deal)
					<div class="grid-item" style="">
						...
						<a class="promotion-list-item" href="/khuyenmai/{{\App\Deals::strtoUrl($deal->deal_title)}}-{{$deal->deal_id}}" title="{{$deal->deal_title}}">
			...
			<div style="text-align: center;padding-top: 80px;font-size: 18px;font-weight: bold; ">Không tìm thấy khuyến mãi</div>
			@endif
