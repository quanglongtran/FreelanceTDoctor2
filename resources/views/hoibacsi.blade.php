				 ...
				 @foreach($selectquestion as $index=>$ques)
				   @if($index==0)
					<div id="col-left">
							...
							<article>
								<div class="caption" style="width:515px;height:350px;">
								
									<a class="image" style="width:515px;height:350px; background-image: url({{$ques->image}});background-size: contain;background-repeat: no-repeat;background-position: center;" href="/hoi-bac-si/tuyen-chon/{{\App\Deals::strtoUrl($ques->subject)}}-{{$ques->id}}/">
                                        <!-- <?php  include "banner/index.html"; ?>   -->    
				...
				@endforeach
					<div id="col-right">
						<ul>
								...
								@if($index!=0)
								<li>
									<a class="image" href="/hoi-bac-si/tuyen-chon/{{\App\Deals::strtoUrl($ques->subject)}}-{{$ques->id}}/" style="background-image: url({{$ques->image}});width:50px;height:50px;display: block;background-size: contain;background-repeat: no-repeat;background-position: center;"></a>
									<h3><a href="/hoi-bac-si/tuyen-chon/{{\App\Deals::strtoUrl($ques->subject)}}-{{$ques->id}}/">{{$ques->subject}}</a></h3>
								</li>
								@endif
							   @endforeach
