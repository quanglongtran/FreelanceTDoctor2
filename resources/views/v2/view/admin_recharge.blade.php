						...
						<tr>
							...
							<td>
								<?php
									...
									$symbol_thousand = ',';
									$decimal_place = 0;
                               		$money = number_format($balance, $decimal_place, '', $symbol_thousand);
                                ?>
								<a class="btn-balance-update" data-id={{$userItem->user_id}} data-balance={{$balance}} href="javascript:void(0)">{{$money}}</a>
							</td>

							<td>{{$userItem->present}}</td>
