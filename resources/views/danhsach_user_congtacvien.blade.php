...
<div id="login" class="has-switch-content  all-others">	
	<div class="position">
		<div class="content">
			<h1><i class="fa fa-user" aria-hidden="true"></i> Danh sách user đã nhập code <strong style="color: red; font-weight: bold">{{$collaboratorsUser}}</strong></h1>
			...
			<table class="table">
				...
				<tr>
					...
					<td><a target="_blank" href="../benhnhan_detail/{{$userData[$idx]->user_id}}">Xem {{$userData[$idx]->so_cau_hoi}} câu hỏi</a></td>
				</tr>
				@endfor
				</tbody>
			</table>
