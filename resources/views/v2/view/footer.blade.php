<footer>
        ...
        <div class="group-footer clr">
            ...
            <div class="span span6 m alone">
                ...
                <ul class="bottom-nav icon-contact">
                    <li>
                        <a class="group-icon-contact" href="https://www.facebook.com/tdoctorvietnam/">
            ...
            <div class="span span4 m alone">
                ...
                <p><strong key="addr" class="langtr" >Việt nam:</strong> 195B Nguyễn Chí Thanh - Phường 12 - Quận 5 - Hồ Chí Minh</br>
                    <strong>USA:</strong> 30590 Cochise Circle suit 204 murrieta ,ca 92563</br>
    ...
    <div class="clr bottom-footer">
        ...
        <p key="abweb1"  class="copyright center langtr fs1" >Website được sở hữu và quản lý bởi: Công ty TNHH bác sĩ trực tuyến Việt Nam.</p>
            <p key="abweb2" class="copyright center langtr fs1" >
            Giấy chứng nhận đăng ký kinh doanh số 0314883204 do Sở Kế hoạch và Đầu tư TP Hồ Chí Minh cấp ngày
            08/02/2018.</p>
    ...
    <div class="global-thread-create-cta">
        <a href="/danh-sach-bac-si" class="button">
            <i class="fa fa-question-circle" aria-hidden="true"></i>
            <strong>Khám online</strong>
        </a>
    </div>
</footer>
