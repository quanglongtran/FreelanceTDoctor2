...
<?php _e( 'Skip to content', 'newsup' ); ?></a>
    <div class="wrapper" id="custom-background-css">
        <header class="mg-headwidget">
            ...
            <div class="mg-nav-widget-area-back" style='background-imagex: url("<?php echo esc_url( $background_image ); ?>" );'>
            <?php $remove_header_image_overlay = get_theme_mod('remove_header_image_overlay',false); ?>
            <img src="<?php echo esc_url( $background_image ); ?>" alt="<?php echo esc_html(get_bloginfo( 'name' )); ?>" />
            <div class="overlay">
