...
<div class="container">
    ...
    <div id="aside">
        ...
        <div class="call-to-action">
            <a href="https://tdoctor.vn/chat" class="dk"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Book now</a>
        </div>

        <div class="achat">
            <a id="chatdt"  href="https://tdoctor.vn/chat">Chat with {{$doctor->doctor_name}}</a>
        </div>
    </div><!--Aside-->
   <div class="content">
