...
<div id="account" class="has-aside">
	...
	<div class="position">
		<aside>
			<section class="collapsible-container collapsible-list">
				...
				<dl>
					...
					<dt>
						<a href="/create-sitemap" ><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> Cập nhật Sitemap</a>
					</dt>
					<dt>
					...
					<dt>
						<a href="/tai-khoan/them-nha-thuoc" ><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> Thêm nhà thuốc</a>
					</dt>
					@endif
		...
		@include('taikhoan.button-naptien')
