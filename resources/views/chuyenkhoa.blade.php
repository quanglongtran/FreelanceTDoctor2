...
<aside class="pulled-up">
    ...
    <section class="top-list">
        ...
        <ul>
            @foreach($doctors as $dr)
	            <li>
	                <a class="image circle" href="/danh-sach/bac-si/{{$dr->doctor_url}}-{{$dr->doctor_id}}/kham-benh" style="background-image: url(https://tdoctor.vn/public/images/doctor/{{$dr->profile_image}});" title="{{$dr->doctor_name}}"></a>
    ...
    <section class="top-list">
        ...
        <ul>
            ...
            <li>
                <a href="/co-so-y-te/{{$cl->clinic_name}}-{{$cl->clinic_id}}/kham-benh" title="{{$cl->clinic_name}}" class="image" style="background-image: url(https://tdoctor.vn/public/images/health_facilities/{{$cl->profile_image}});"></a>
