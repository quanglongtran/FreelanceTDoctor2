	...
	<div id="detail" class="has-actions">
		...
		<div class="item">
					...
					<div class="call-to-action">
						...
						<a href="https://tdoctor.vn/dang-ky" class="button secondary">
							Đặt khám ngay
						</a>
							{{--<a href="https://tdoctor.vn/dang-ky" class="sticky-nav-link action-book button" title="Đặt khám tại Khoa Khám chữa bệnh theo yêu cầu - Bệnh viện Đại học Y Hà Nội" data-place-id="29068">--}}
