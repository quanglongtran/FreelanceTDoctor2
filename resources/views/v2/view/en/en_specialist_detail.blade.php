          ...
          <section class="ck-professionals">
                <h3>
                   The outstanding doctor has this specialty
                    <a href="/danh-sach-bac-si-chi-tiet/?specialities=san-phu" title="Xem danh sách bác sĩ">Show all <i class="fa fa-angle-double-right"></i></a>
                </h3>
                 @if(isset($doctors)) 
                      <div class="prev-ck">
            ...
            <section class="ck-professionals" >
                <h3>
                    ...
                    <a href="/danh-sach/?specialities=san-phu" title="Xem danh sách cơ sở y tế">Show all <i class="fa fa-angle-double-right"></i></a>
                </h3>
                 @if(isset($clinics)) 
            ...
            <section class="ck-top-list">
                ...
                <ul>
                    ...
                    <li class="ck-ud-dropd">
                        <a class="image" id="test" href="/en/hoibacsi/{{$ques->question_url}}-{{$ques->question_id}}/" style="background-image: url();" title="Dùng thuốc bổ khi mang thai: Những điều bạn nên biết"></a>
