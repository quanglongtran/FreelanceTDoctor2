    ...
    ! function(e) {
        ...
        function() {
            ...
            var t = e("jquery"),
                ...
                c = function(e) {
                    n.get("email") && e.find('input[name="email"]').val(n.get("email")), e.submit(function(l) {
                        {
                            var c = t(this),
                                u = e.find('input[name="email"]').val(),
                                d = e.find('input[name="password"]').val(),
                                p = i.api.account.login + window.location.search || "",
                                h = c.data("link");
                            r.getParamValue("type", p), r.getParamValue("next", h)
                        }
                        c.addClass("submitting"), "facebook" == c.attr("name") ? window.location.href = h : (t.ajax(p, {
                            headers: {
                                "X-XSRF-TOKEN": n.get("XSRF-TOKEN")
                            },
                            contentType: "application/json; charset=utf-8",
                            ...
                            c.removeClass("submitting"), a.open(t('<p>Chào mừng bạn đến với BacsiViet!</p><div><a href="' + e.next + '" class="button">OK</a></div>'), "no-close-button"), o.page("/dang-nhap/hoan-thanh/web-bacsiviet/", "Đăng nhập thành công"), setTimeout(function() {
                                console.log(e.next);
                                window.location = e.next
                            }, s)
                        }).fail(function(e) {
                            c.removeClass("submitting"), a.openAlert(t("<p>Địa chỉ email hoặc mật khẩu bạn vừa nhập chưa đúng. Xin vui lòng thử lại.</p>")), o.page("/dang-nhap/loi/", "Đăng nhập gặp lỗi " + e.responseText)
                        }), l.preventDefault())
                    })
                };
            return {
